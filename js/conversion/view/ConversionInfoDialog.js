...
const conversionStringMultiLine = LabSuhuStrings.info.conversion;

class ConversionInfoDialog extends Dialog {
    constructor() {
        ...
        const content = new VBox( {
            spacing: 15,
            children: conversionStringMultiLine.split("\n").map( ( str, idx ) => new HBox( {
                spacing: 20,
                align: 'top',
                children: [
...
labSuhu.register( 'ConversionInfoDialog', ConversionInfoDialog );
export default ConversionInfoDialog;