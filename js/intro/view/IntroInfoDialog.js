...
const infoStringMultiLine = LabSuhuStrings.info.intro;

class IntroInfoDialog extends Dialog {
    constructor() {
        ...
        const content = new VBox( {
            spacing: 15,
            children: infoStringMultiLine.split("\n").map( ( str, idx ) => new HBox( {
                spacing: 20,
                align: 'top',
                children: [
...
labSuhu.register( 'IntroInfoDialog', IntroInfoDialog );
export default IntroInfoDialog;