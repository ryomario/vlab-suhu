...
type SelfOptions = {
 //TODO add options that are specific to ScaleScreenView here
};

type ScaleScreenViewOptions = SelfOptions & ScreenViewOptions;

class ScaleScreenView extends ScreenView {

  public constructor( model: ScaleModel, providedOptions: ScaleScreenViewOptions ) {

    const options = optionize<ScaleScreenViewOptions, SelfOptions, ScreenViewOptions>()( {
