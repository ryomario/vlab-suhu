...
/**
 * model for all screens in Lab Suhu Simulations
 *
...
class IntroModel {
    ...
    constructor( providedOptions ) {
        ...
        const options = merge( {
            ...
            numberOfGroundSpots: NUMBER_OF_GROUND_SPOTS,
        }, providedOptions );
     ...
     for ( let i = 0; i < options.numberOfGroundSpots; i++ ) {
     ...
     this.rightBoxBounds = new Bounds2(
     ...
     this.rightBoxVisibility = new BooleanProperty( false, {
